...
public class HourlyWeatherIcon extends HourlyWeather {
    ...
    public static HourlyWeatherIcon createFrom(WeatherRes weatherRes) {
        HourlyRes response = weatherRes.getHourly().getWeatherIcon();
        return HourlyWeatherIcon.builder()
