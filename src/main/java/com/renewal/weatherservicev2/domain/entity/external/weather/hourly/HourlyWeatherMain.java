...
import com.renewal.weatherservicev2.domain.entity.external.abstr.HourlyWeatherInterface;
...
public class HourlyWeatherMain extends HourlyWeather {
    ...
    public static HourlyWeatherMain createFrom(WeatherRes weatherRes) {
        HourlyRes response = weatherRes.getHourly().getWeatherMain();
        return HourlyWeatherMain.builder()
