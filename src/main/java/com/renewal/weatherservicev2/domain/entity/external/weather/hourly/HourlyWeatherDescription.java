...
public class HourlyWeatherDescription extends HourlyWeather {
    ...
    public static HourlyWeatherDescription createFrom(WeatherRes weatherRes) {
        HourlyRes response = weatherRes.getHourly().getWeatherDescription();
        return HourlyWeatherDescription.builder()
