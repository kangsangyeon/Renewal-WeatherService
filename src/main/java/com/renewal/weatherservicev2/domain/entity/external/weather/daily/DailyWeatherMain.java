...
@NoArgsConstructor
@AllArgsConstructor
public class DailyWeatherMain extends DailyWeather implements DailyWeatherInterface {
    ...
    public static DailyWeatherMain createFrom(WeatherRes weatherRes) {
        DailyRes response = weatherRes.getDaily().getWeatherMain();
        return DailyWeatherMain.builder()
