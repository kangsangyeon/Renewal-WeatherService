...
@NoArgsConstructor
@AllArgsConstructor
public class WeedsPollenRiskIdxReq extends LivingAndHealthIdxReq implements OpenApiRequestInterface {
    ...
    public URL makeUrl() {
        try {
            String url = OpenApiURL.OPEN_API_URL_FOR_HEALTH + OpenApiURL.SUB_URL_FOR_WEEDS_POLLEN_RISK_IDX + makeCommonSubUrl(admCode, date);
            return new URL(url);
