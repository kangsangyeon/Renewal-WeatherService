...
@NoArgsConstructor
@AllArgsConstructor
public class StrokeIdxRequestVO extends HealthIdxRequestVO implements OpenApiRequestInterface {
    ...
    public URL makeUrl() {
        try {
            String url = Const.OPEN_API_URL_FOR_HEALTH + Const.SUB_URL_FOR_STROKE_IDX + makeCommonSubUrl(admCode, date);
            return new URL(url);
